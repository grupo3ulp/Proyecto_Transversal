 ...
 * @author Moon
 */
public class GUIBuscarInscripcion extends javax.swing.JFrame {

    /**
     * Creates new form GUIBuscarInscripcion
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIBuscarInscripcion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIBuscarInscripcion().setVisible(true);
            }
        });
    }
